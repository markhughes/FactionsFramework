...
public class Command_2_8_16 extends com.massivecraft.factions.cmd.FactionsCommand implements CommandBase {
	...
	public Command_2_8_16(FactionsCommand command) {
		...
		if (command.getSubCommands().size() > 0) {
			for (FactionsCommand subCommand : command.getSubCommands()) {
				this.addChild(new Command_2_8_16(subCommand));
			}
		}
